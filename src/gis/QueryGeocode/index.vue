...
import { TMapLayerSetting, TMapOptions, GISToolHelper } from 'qm-map-wrapper'
import { defineModel, onUpdated, ref } from 'vue'
import MapWidget from '../MapWidget/index.vue'
...
<template>
  ...
  >
    ...
    >
      <div
        :style="{ fontSize: '16px', color: '#584B4B', fontWeight: 'bold', marginBottom: '20px' }"
      >
        获取经纬度和地址 ：
      </div>
      <Row>
      ...
      <Row>
        <Col :offset="1" :span="23">
          <MapWidget
            ...
            :map-layer-setting="mapSetting"
            @on-map-load="mapLoadHandle"
          />
        </Col>
      </Row>
    </Form>
